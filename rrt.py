...
from TestParameters.cases import TestParameters
...
def get_nearest_node(nodes, pick):
...
class RRT:
    ...
    def search_path(self):
        ...
        while True:
            ...
            nearest = get_nearest_node(nodes, pick)
        ...
        route = backtracking(final_node) + dubins_route
